...
class _MazeMasterState extends State<MazeMasterScreen> {
  ...
  Widget _buildGame() {
    ...
    if (_ctrlX == null) {
      _ctrlX = (MediaQuery.of(context).size.width - 180) / 2;
      _ctrlY = MediaQuery.of(context).size.height - 240;
    }
    return Stack(children: [
      Column(children: [
        ...
        // Maze
        Expanded(child: Center(child: _won ? _wonCard() : FittedBox(child: Container(
      ...
      if (!_won) Positioned(
        ...
        child: GestureDetector(
          onPanUpdate: (details) {
            setState(() {
              _ctrlX = (_ctrlX! + details.delta.dx);
              _ctrlY = (_ctrlY! + details.delta.dy);
            });
          },
          child: Container(
